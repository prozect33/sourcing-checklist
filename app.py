        ...
        if 'result' in locals() and result:
            ...
            if sell_price is None or qty is None:
                ...
                for bg_color, values in [
                    ...
                    st.markdown(f"""
<div style='display: grid; grid-template-columns: 0.1fr 1fr 1fr 0.3fr 0.3fr; background: {bg_color}; padding: 12px 18px; border-radius: 10px; text-align: center; align-items: center; gap: 8px; margin-bottom: 12px;'>
