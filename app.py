    ...
    if sell_price_raw.strip():
        try:
            ...
            while left_b <= right_b:
                ...
                # ✅ 48~52% 구간일 때만 출력
                if 48 <= margin_mid <= 52:
                    st.write(f"🧪 mid={mid}, unit_cost={unit_cost}, fee={fee}, ad_fee={ad_fee}, etc={etc_cost}, "
                             f"inout={inout_cost}, return_cost={return_cost}, total_cost={total_cost}, "
                             f"margin_profit={margin_profit}, margin_mid={margin_mid:.2f}%")
